...
method_inter = ["linear","polynomial","polynomial","polynomial","from_derivatives","spline","spline","spline"
                ,"spline","slinear","quadratic","cubic","akima","pchip","piecewise_polynomial"]   
...
site = ['U1480']
hole = ['E']
core = np.arange(start=1, stop=13, step=1)
typee = ['H']
            ...
            for xxx in range(0,len(hole)):
                for xxxx in range(0,len(core)):
                    for xxxxx in range(0,len(sect)):
                        ...
                        if (y == 1):
                            nome = 'full_interp_csv_'+str(exp[x])+"_"+site_str+'_'+hole_str+"_"+core_str+typee_str+"_"+str(method_inter[y])+"_order_1.csv"
                            name_file = patch_properties+str(method_inter[y])+'_order_1_full_'+str(exp[x])+"_"+site_str+'_'+hole_str+".csv"
                            
                        elif (y == 2):
                            nome = 'full_interp_csv_'+str(exp[x])+"_"+site_str+'_'+hole_str+"_"+core_str+typee_str+"_"+str(method_inter[y])+"_order_2.csv"
                            name_file = patch_properties+str(method_inter[y])+'_order_2_full_'+str(exp[x])+"_"+site_str+'_'+hole_str+".csv"
                            
                        elif (y == 3):    
                            nome = 'full_interp_csv_'+str(exp[x])+"_"+site_str+'_'+hole_str+"_"+core_str+typee_str+"_"+str(method_inter[y])+"_order_3.csv"
                            name_file = patch_properties+str(method_inter[y])+'_order_3_full_'+str(exp[x])+"_"+site_str+'_'+hole_str+".csv"
                            ...
                            nome = 'full_interp_csv_'+str(exp[x])+"_"+site_str+'_'+hole_str+"_"+core_str+typee_str+"_"+str(method_inter[y])+"_order_4.csv"
                            name_file = patch_properties+str(method_inter[y])+'_order_4_full_'+str(exp[x])+"_"+site_str+'_'+hole_str+".csv"
                        else:
