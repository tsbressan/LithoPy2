...
class Exec1(wx.Frame): 
   def __init__(self, parent, title): 
      ...
      text = wx.StaticText(panel, -1, "Interpolation of values")
      ...
      self.load_file_button1 = wx.Button(panel, -1, "dataset1-u1480")
      self.load_file_button1.Bind(wx.EVT_BUTTON, self.Selectdataset1_u1480)
      
      self.load_file_button2 = wx.Button(panel, -1, "dataset1-u1481")
   ...
   def Selectdataset0(self,event):
      import Selectdataset0
      ex = Selectdataset0.Exec(None)
      ex.Show()
      
   def Selectdataset1_u1480(self,event):
      import Selectdataset1_u1480
      ex = Selectdataset1_u1480.Exec(None)
      ex.Show()    
      
   def Selectdataset1_u1481(self,event):
      import Selectdataset1_u1481
      ex = Selectdataset1_u1481.Exec(None)
      ex.Show()  
